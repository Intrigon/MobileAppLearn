    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Halaman1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent switchActivityIntent = new Intent(MainActivity.this, DeteksiSensor.class);
        ...
        Halaman2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent switchActivityIntent = new Intent(MainActivity.this, PembacaanDataSensor.class);
                startActivity(switchActivityIntent);
            }
        });
    }
